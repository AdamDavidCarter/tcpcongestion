...
// Install FqCoDel-L4S on bottleneck link (n1-n2)
TrafficControlHelper tch;
uint16_t handle = tch.SetRootQueueDisc("ns3::FqCoDelQueueDisc");
Config::SetDefault("ns3::FqCoDelQueueDisc::L4sMode", BooleanValue(true));
...
// ---------------- L4S via FqCoDel (ECN marking) ----------------
// Use an ECN-capable TCP (e.g., DCTCP) to respond to L4S queue marking
